<template>
  <transition name="move">
    <div class="wrapper b">
      <x-header :left-options="{backText: ''}">服务统计</x-header>
      <tab>
  ...
  export default {
    ...
    methods: {
      ...
      _requestData () {
        ...
        request.get(getUrl(this.selectIndex == 2 ?  'serviceKpi':'serviceType'),this.selectIndex == 2 ?  {} : {dataType:this.dataType[this.selectIndex]}).then(res => {
          if(res.success){
